...
from Config import STRING, SUDO, BIO_MESSAGE, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, HEROKU_API_KEY
import asyncio
...
async def start_atgk():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@javes2support"))
            await idk(functions.channels.JoinChannelRequest(channel="@javesgroup"))
